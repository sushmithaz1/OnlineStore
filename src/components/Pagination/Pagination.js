...
class Pagination extends Component {
    ...
    render() {
        ...
        const pages =this.getPages().map(pageNum => {
            ...
            {/**If  page num is equal to current page make it as active and display page number*/}
        ...
        {/**Make it disabled when we are in the first page*/}
        if (this.props.currentPage === 1) {
            prevButtonClass += ' disabled';
        }
        {/**Call previous method when user clicks previous button */}
    ...
    {/**Call next page when user clicks next button and make it disable if user in last page */}
        const nextButton = (
